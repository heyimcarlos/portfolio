...
title: Ntornos
year: '2023'
description: Real estate platform with an interactive map, area-specific search, color-coded market-duration markers, and globally adaptable currency and language.
stack: [Next.js, React, TailwindCSS, tRPC, Prisma, MySQL, AWS]
category: web
cover: /src/assets/projects/ntornos.png
status: acquired
