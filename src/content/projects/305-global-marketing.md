...
year: '2022'
description: Multi-tenant e-commerce platform with customizable franchise stores, wallets, affiliate commissions, and USPS-backed shipping.
stack: [Next.js, React, Node.js, Express, tRPC, Prisma, MongoDB, AWS]
category: web
cover: /src/assets/projects/305-global-marketing_thumbnail.png
status: shipped
updatedDate: 'Oct 27 2022'
role: Lead Software Engineer
---

**305 Global Marketing** is a multi-tenant e-commerce platform that allows users to build a fully customizable franchise store from which they can buy and sell products to earn discounts, commissions, and bonuses.
